      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
        <div className="flex h-16 items-center gap-4 px-4">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md text-sm font-medium hover:bg-accent h-9 w-9"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold">PlotOps</span>
          </Link>
          ...
          <div className="flex-1 flex items-center justify-end gap-4">
            ...
            <button className="inline-flex items-center justify-center rounded-md text-sm font-medium hover:bg-accent h-9 w-9 relative">
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
